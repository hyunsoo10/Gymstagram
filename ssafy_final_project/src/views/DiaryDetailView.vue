<template>
    <div class="container">
        ...
        <div class="card-body">
            ...
            <p class="card-text"
                style="display: flex; justify-content: space-around;   align-items: center; width: 70%; margin: 5px auto;">
            <div><i class="fas fa-user-circle" style="color: #727479;"></i> {{ diaryStore.diary.userId }} &nbsp;&nbsp;</div>
            <small class="text-body-secondary"><i class="fas fa-eye" style="color: #727479;"></i>
                <strong>{{ diaryStore.diary.viewCount }}</strong></small>
            <small class="text-body-secondary"><i class="fa-regular fa-thumbs-up" style="color: #727479;"></i>
                <strong>{{ diaryStore.diary.likeCount }}</strong> </small>
            <small class="card-text"><i class="fas fa-calendar-alt" style="color: #727479;"></i>
                {{ diaryStore.diary.createDate }} </small>
            </p>
