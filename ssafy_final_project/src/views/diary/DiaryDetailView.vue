  ...
  <div class="container" v-if="userStore.loginUser != null">
    ...
    <div class="diary-body">
      ...
      <img class="card-img-top diray-img"
        ...
        onerror="this.src='../src/assets/Gymstagram2.png'" />
      <p class="diary-info">
    ...
    <form v-if="userStore.loginUser" class="row gx-3 gy-2 align-items-end justify-content-center" id="commentForm">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="comment-content" v-model.trim="newContent" placeholder="댓글을 작성해주세요"
          @keyup.enter="createComment" />
      </div>


      <div class="col-auto">
        <button type="button" @click="createComment" class="btn"><i class="fa-regular fa-paper-plane fa-bounce"
            style="color: #109452;"></i></button>
      </div>
    </form>
