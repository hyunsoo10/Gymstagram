      ...
      <section class="d-flex flex-column">
        <div class="regist-form">
          <div class="form-content">
            ...
            <input type="email" id="email" placeholder="이메일을 입력해주세요.(중복불가능)" :value="kakaoInfo.email" readonly>
            <br>
            <label for="userNickname">
              닉네임
              <img class="icon-star" src="@/assets/icon_star.png" />
            </label>
            <input type="text" id="userNickname" placeholder="닉네임를 입력해주세요.(중복불가능, 특수문자 제외)" v-model="kakaoInfo.nickName">
            <br>
