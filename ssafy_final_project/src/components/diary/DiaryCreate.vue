      ...
      <div class="create">
        <div class="create-form">
          ...
          <div class="form-floating mb-3">
            <input type="text" class="form-control" id="title" placeholder="제목" v-model.trim="diary.title"
              :required="required">
          ...
          <!--Drag & Drop 파일 업로드-->
          <div @dragenter="onDragenter" @dragover.prevent="onDragover" @dragleave="onDragleave" @drop.prevent="onDrop"
            @click="$refs.filebtn.click()" @change="upload" :ref="image" class="drag-box">
